package com.multiple.ds.api.config;
...
basePackages = {
		"com.multiple.ds.api.book.repository" })
public class BookDBConfig {
	...
	public LocalContainerEntityManagerFactoryBean bookEntityManagerFactory(EntityManagerFactoryBuilder builder,
		...
		return builder.dataSource(dataSource).properties(properties).packages("com.multiple.ds.api.model.book")
